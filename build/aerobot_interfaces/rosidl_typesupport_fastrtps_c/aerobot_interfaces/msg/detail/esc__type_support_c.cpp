...
#include "aerobot_interfaces/msg/detail/esc__rosidl_typesupport_fastrtps_c.h"
...
using _Esc__ros_msg_type = aerobot_interfaces__msg__Esc;
...
size_t get_serialized_size_aerobot_interfaces__msg__Esc(
  const void * untyped_ros_message,
...
static uint32_t _Esc__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aerobot_interfaces__msg__Esc(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aerobot_interfaces
size_t max_serialized_size_aerobot_interfaces__msg__Esc(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aerobot_interfaces__msg__Esc;
    is_plain =
      (
...
static size_t _Esc__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aerobot_interfaces__msg__Esc(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aerobot_interfaces, msg, Esc)() {
