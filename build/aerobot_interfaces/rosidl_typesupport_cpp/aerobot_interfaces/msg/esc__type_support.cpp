...
static const _Esc_type_support_symbol_names_t _Esc_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aerobot_interfaces, msg, Esc)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aerobot_interfaces, msg, Esc)),
  }
};
...
{
  return &::aerobot_interfaces::msg::rosidl_typesupport_cpp::Esc_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aerobot_interfaces, msg, Esc)() {
  return get_message_type_support_handle<aerobot_interfaces::msg::Esc>();
}
