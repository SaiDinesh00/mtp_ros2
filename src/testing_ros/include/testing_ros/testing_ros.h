...
//
#ifndef RTW_HEADER_testing_ros_h_
#define RTW_HEADER_testing_ros_h_
#include "rtwtypes.h"
...
struct B_testing_ros_T {
  ...
  real_T a[9];
  real_T TmpSignalConversionAtMathFu[3];
  real_T Phi;                          // '<S3>/Atan1'
  real_T Theta;                        // '<S3>/Atan2'
...
struct DW_testing_ros_T {
  ...
  uint8_T is_active_c2_testing_ros;    // '<S3>/MATLAB Function'
};

// Parameters (default storage)
struct P_testing_ros_T_ {
...
extern "C"
{
  ...
  extern P_testing_ros_T testing_ros_P;
...
extern "C"
{
  ...
  extern struct B_testing_ros_T testing_ros_B;
...
extern struct DW_testing_ros_T testing_ros_DW;
...
extern "C"
{
  ...
  extern void testing_ros_initialize(void);
  extern void testing_ros_step(void);
  extern void testing_ros_terminate(void);
...
extern "C"
{
  ...
  extern RT_MODEL_testing_ros_T *const testing_ros_M;
...
//
//  '<Root>' : 'testing_ros'
//  '<S1>'   : 'testing_ros/Subscribe'
//  '<S2>'   : 'testing_ros/Subscribe1'
//  '<S3>'   : 'testing_ros/Subsystem'
//  '<S4>'   : 'testing_ros/Subscribe/Enabled Subsystem'
//  '<S5>'   : 'testing_ros/Subscribe1/Enabled Subsystem'
//  '<S6>'   : 'testing_ros/Subsystem/MATLAB Function'
//  '<S7>'   : 'testing_ros/Subsystem/Normalize Vector'

#endif                                 // RTW_HEADER_testing_ros_h_
