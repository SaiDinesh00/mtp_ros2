...
//
#ifndef RTW_HEADER_testing_ros_types_h_
#define RTW_HEADER_testing_ros_types_h_
#include "rtwtypes.h"
...
typedef struct P_testing_ros_T_ P_testing_ros_T;

// Forward declaration for rtModel
typedef struct tag_RTM_testing_ros_T RT_MODEL_testing_ros_T;

#endif                                 // RTW_HEADER_testing_ros_types_h_
